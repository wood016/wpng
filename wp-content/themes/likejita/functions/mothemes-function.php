...
get_template_part( "functions/mothemes-widget" );
...
{
		get_template_part( "functions/mothemes-admin" );
}
...
add_action( "wp_enqueue_scripts", "mothemes_script" );
...
add_action( "init", "mothemes_admin_redirect" );
...
function time_since( $older_date, $comment_date = FALSE, $return = FALSE )
{
		...
		if ( $since < 2592000 )
		{
				...
				for ( ;	$i < $j;	++$i	)
				{
						...
						{
						case 0 :
								$name = __( "Month", "MoThemes" );
								break;
						case 1 :
								$name = __( "Day", "MoThemes" );
								break;
						case 2 :
								$name = __( "Hour", "MoThemes" );
								break;
						case 3 :
								$name = __( "Minute", "MoThemes" );
								break;
						case 4 :
								$name = __( "Second", "MoThemes" );
						}
				...
				$output = $count.$name.__( "ago", "MoThemes" );
		}
		else
		{
...
function mothemes_admin_redirect( )
{
...
function mothemes_profile_fields( $contactmethods )
{
		$contactmethods['cover'] = __( "cover", "MoThemes" );
		$contactmethods['following'] = __( "following", "MoThemes" );
		$contactmethods['followers'] = __( "followers", "MoThemes" );
		$contactmethods['likes'] = __( "likes", "MoThemes" );
		$contactmethods['mfavatar'] = __( "mfavatar", "MoThemes" );
		return $contactmethods;
}

function mothemes_archives_list( )
{
